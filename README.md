...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .horizontal-row { width: 100%; max-width: 1200px; margin: 0 auto 25px auto; padding: 0 15px; display: flex; gap: 12px; align-items: stretch; } 
        ...
        .copy-btn { margin-top: 12px; background: #111; color: #fff; border: none; padding: 8px 16px; border-radius: 6px; font-size: 0.8rem; font-weight: 700; cursor: pointer; width: fit-content; }
